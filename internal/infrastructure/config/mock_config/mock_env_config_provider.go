...
// Source: internal/config/env_config_provider.go
//
// Generated by this command:
//
//      mockgen -source=internal/config/env_config_provider.go
//
...
func (mr *MockEnvGetterMockRecorder) LookupEnv(key any) *gomock.Call {
